...
INSERT INTO `departamento` VALUES (3,'Administrativo'),(1,'Cardiologia'),(5,'Laboratório'),(2,'Pediatria'),(4,'Radiologia');
...
INSERT INTO `exame` VALUES (4,'Biópsia'),(3,'Eletrocardiograma (ECG)'),(1,'Hemograma Completo'),(2,'Raio-X de Tórax');
...
INSERT INTO `exame_solicitado` VALUES (1,3,3,'2025-11-26 09:00:00','Resultado do ECG: Ritmo sinusal.'),(2,4,4,'2025-11-29 15:00:00','Resultado da Biópsia: Negativo para malignidade.'),(3,5,2,'2025-11-27 12:00:00','Raio-X de Tórax sem alterações.');
...
CREATE TABLE `medico` (
  ...
  CONSTRAINT `fk_medico_departamento` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id_departamento`)
...
INSERT INTO `medico` VALUES (1,'Dr. Pedro Álvares','CRM/SP 12345','Cardiologia',1),(2,'Dra. Ana Costa','CRM/RJ 67890','Clínico Geral',3),(3,'Dr. Roberto Dias','CRM/MG 23456','Pediatria',2),(4,'Dra. Laura Silva','CRM/SP 34567','Dermatologia',5),(5,'Dr. Marcos Rocha','CRM/RJ 45678','Ginecologia',3);
...
-- Dump completed on 2025-11-25 20:12:14
